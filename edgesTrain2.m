function model = edgesTrain2( varargin )
...
dfs={'imWidth',32, 'gtWidth',16, 'nPos',1e6, 'nNeg',1.5e6, 'nImgs',inf, ...
  'nTrees',6, 'fracFtrs',1/4, 'minCount',1, 'minChild',8, ...
  'maxDepth',128, 'discretize','pca', 'nSamples',256, 'nClasses',9, ...
  'split','gini', 'nOrients',4, 'grdSmooth',0, 'chnSmooth',2, ...
  'simSmooth',8, 'normRad',4, 'shrink',1, 'nCells',8, 'rgbd',0, ...
  'stride',2, 'multiscale',1, 'sharpen',1, 'nTreesEval',6, ...
